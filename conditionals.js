...
// ==========================================
const outcome1 = 10 > 20;
console.log("Is 10 groter dan 20?", outcome1);
// ==========================================
...
// ==========================================
const outcome2 = 10 !== 11;
console.log("Is 10 ongelijk aan 11?", outcome2)

// ==========================================
// 3. Declareer een variabele en sla daar in op of de woorden 'zoet' en 'sappig' hetzelfde zijn                // geeft false wanneer gelogd
// ==========================================
const same = "zoet" === "sappig";
console.log("Zijn de woorden zoet en sappig hetzelfde?", same);
